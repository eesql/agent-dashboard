  ...
  useEffect(() => {
    ...
    class CarLights {
      ...
      init() {
        ...
        if (Array.isArray(colors)) {
          colorArray = colors.map(c => new THREE.Color(c));
        } else {
          colorArray = [new THREE.Color(colors)];
        }
        ...
        for (let i = 0; i < options.lightPairsPerRoadWay; i++) {
          ...
          let color = pickRandom(colorArray);
          aColor.push(color.r);
          aColor.push(color.g);
          aColor.push(color.b);
    ...
    class LightsSticks {
      ...
      init() {
        ...
        let colorArray: THREE.Color[];
        if (Array.isArray(colors)) {
          colorArray = colors.map((c: number) => new THREE.Color(c));
        } else {
          colorArray = [new THREE.Color(colors)];
        }
